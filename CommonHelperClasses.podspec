#
# Be sure to run `pod lib lint CommonHelperClasses.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CommonHelperClasses'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CommonHelperClasses.'
